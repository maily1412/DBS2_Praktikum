...
rem 	Owner  : ahunold
rem
rem 	Script Name: 	hr_popul.sql
rem
rem 	Purpose: 	Populate script for the HR schema
rem
rem
rem 	NOTES
...
rem
rem 	Created by:  	Nancy Greenberg and Nagavalli Pataballa on 01-JUN-2000
rem
rem   	ahunold on 07-MAR-2001: 
rem				- small data errors corrected
...
rem   	ahunold   		20-FEB-2001 - NLS_LANGUAGE, replacing non American
rem   	ahunold   		09-JAN-2001 - checkin ADE
rem   	Chaitanya Koratamaddi - 05-FEB-2006
rem	Lauran K. Serhal 	20-JUL-2007
